...
if (!PUBLIC_KEY || !SECRET_KEY) {
  console.error(
    JSON.stringify({
      error:
        'PARTNERSTACK_PUBLIC_KEY and PARTNERSTACK_SECRET_KEY environment variables required',
    }),
  )
  process.exit(1)
}
  ...
  switch (cmd) {
    case 'partnerships':
      switch (sub) {
        ...
        case 'get': {
          const key = args.key
          if (!key) {
            result = { error: '--key required (partnership key)' }
            break
          }
        ...
        case 'create': {
          ...
          if (!group) {
            result = { error: '--group required (group key)' }
            break
          }
        ...
        default:
          result = {
            error:
              'Unknown partnerships subcommand. Use: list, get, create, update',
          }
      }
      break
    ...
    case 'customers':
      switch (sub) {
        ...
        case 'get': {
          const key = args.key
          if (!key) {
            result = { error: '--key required (customer key)' }
            break
          }
        ...
        case 'create': {
          ...
          if (!partnerKey) {
            result = { error: '--partner-key required' }
            break
          }
        ...
        default:
          result = {
            error:
              'Unknown customers subcommand. Use: list, get, create, update, delete',
          }
      }
      break
    ...
    case 'transactions':
      switch (sub) {
        ...
        case 'get': {
          const key = args.key
          if (!key) {
            result = { error: '--key required (transaction key)' }
            break
          }
        ...
        case 'create': {
          ...
          if (!customerKey) {
            result = { error: '--customer-key required' }
            break
          }
          if (!amount) {
            result = { error: '--amount required (in cents)' }
            break
          }
          const body = {
        ...
        default:
          result = {
            error:
              'Unknown transactions subcommand. Use: list, get, create, delete',
          }
      }
      break
    ...
    case 'deals':
      switch (sub) {
        ...
        case 'get': {
          const key = args.key
          if (!key) {
            result = { error: '--key required (deal key)' }
            break
          }
        ...
        default:
          result = {
            error:
              'Unknown deals subcommand. Use: list, get, create, update, archive',
          }
      }
      break
    ...
    case 'actions':
      switch (sub) {
        ...
        case 'create': {
          ...
          if (!actionKey) {
            result = { error: '--action-key required' }
            break
          }
          const body = {
            customer_key: customerKey,
    ...
    case 'leads':
      switch (sub) {
        ...
        case 'get': {
          const key = args.key
          if (!key) {
            result = { error: '--key required (lead key)' }
            break
          }
        ...
        default:
          result = {
            error: 'Unknown leads subcommand. Use: list, get, create, update',
          }
      }
      break
    ...
    case 'webhooks':
      switch (sub) {
        ...
        case 'get': {
          const key = args.key
          if (!key) {
            result = { error: '--key required (webhook key)' }
            break
          }
        ...
        case 'create': {
          ...
          if (!target) {
            result = { error: '--target required (webhook URL)' }
            break
          }
          const body = { target }
        ...
        default:
          result = {
            error:
              'Unknown webhooks subcommand. Use: list, get, create, delete',
          }
      }
      break
    ...
    default:
      result = {
        ...
        usage: {
          partnerships:
            'partnerships [list | get --key <key> | create --email <email> --group <group-key> | update --key <key>]',
          customers:
            'customers [list | get --key <key> | create --email <email> --partner-key <key> | update --key <key> | delete --key <key>]',
          transactions:
            'transactions [list | get --key <key> | create --customer-key <key> --amount <cents> | delete --key <key>]',
          deals:
            'deals [list | get --key <key> | create --partner-key <key> --name <name> | update --key <key> | archive --key <key>]',
          actions:
            'actions [list | create --customer-key <key> --action-key <key> [--value <n>]]',
          rewards:
            'rewards [list | create --partner-key <key> --amount <cents>]',
          leads:
            'leads [list | get --key <key> | create --partner-key <key> --email <email> | update --key <key>]',
          groups: 'groups [list]',
          webhooks:
            'webhooks [list | get --key <key> | create --target <url> [--events <evt1,evt2>] | delete --key <key>]',
          options:
            '--limit <n> --after <cursor> --before <cursor> --order-by <field>',
        },
      }
  }
