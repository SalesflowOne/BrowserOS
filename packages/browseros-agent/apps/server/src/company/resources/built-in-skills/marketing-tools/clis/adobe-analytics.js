...
if (!ACCESS_TOKEN || !CLIENT_ID || !COMPANY_ID) {
  console.error(
    JSON.stringify({
      error:
        'ADOBE_ACCESS_TOKEN, ADOBE_CLIENT_ID, and ADOBE_COMPANY_ID environment variables required',
    }),
  )
  process.exit(1)
}
    ...
    default:
      result = {
        ...
        usage: {
          ...
          reports:
            'reports run --rsid <report_suite_id> --start-date <YYYY-MM-DD> --end-date <YYYY-MM-DD> --metrics <metrics> [--dimension <dimension>]',
