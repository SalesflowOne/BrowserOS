...
- [Sanity](../../marketing-tools/integrations/sanity.md) — GROQ queries, mutations, CLI
- [Contentful](../../marketing-tools/integrations/contentful.md) — Delivery/Management APIs, publishing
- [Strapi](../../marketing-tools/integrations/strapi.md) — REST CRUD, filters, document API
