...
import { findCursorHits } from './core/observer/cursor-augment'
import type { AXNode } from './core/snapshot/ax-types'
import {
  INTERACTIVE_ROLES,
  NAMED_CONTENT_ROLES,
  ROOT_ROLES,
  SKIP_ROLES,
} from './core/snapshot/roles'

export type { AXNode } from './core/snapshot/ax-types'
