...
from bos_build.common.context import Context
from bos_build.common.products import get_product_descriptor
from bos_build.modules.package.linux import (
...
class HostAppImageToolTest(unittest.TestCase):
    ...
    def test_x64_host_picks_x86_64_tool(self) -> None:
        with patch(
            "bos_build.modules.package.linux.get_platform_arch", return_value="x64"
        ):
    ...
    def test_arm64_host_picks_aarch64_tool(self) -> None:
        with patch(
            "bos_build.modules.package.linux.get_platform_arch", return_value="arm64"
        ):
            filename, url = get_host_appimagetool()
...
class CopyBrowserFilesTest(unittest.TestCase):
    def test_copies_browseros_and_claw_server_roots_when_present(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("bos_build.modules.package.linux.log_warning"):
