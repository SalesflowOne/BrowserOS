...
class GitSetupExecuteTest(unittest.TestCase):
    ...
    def test_checks_out_tag_as_browseros_branch(self):
        ...
        with (
            mock.patch("bos_build.modules.setup.git.run_command", fake_run_command),
            mock.patch("bos_build.modules.setup.git.IS_LINUX", return_value=False),
            mock.patch("bos_build.modules.setup.git.IS_WINDOWS", return_value=False),
